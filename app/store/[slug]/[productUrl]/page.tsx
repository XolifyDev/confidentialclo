        ...
        <>
            {domLoaded ? (
                <>
                    ...
                    }} className={`relative flex min-h-screen h-screen flex-col items-center justify-between ${!isMobile ? "-mt-[7.695vh]" : rdd.isMobileSafari ? "-mt-[9.1vh]" : "-mt-[8.9vh]"} mb-[5%] pt-16`}>
